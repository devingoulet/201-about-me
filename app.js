...
function goRunningQuestion(){
  goRunning = prompt('Do I like to run? Yes or No').toLowerCase();
  if(goRunning === 'yes') {
...
function howManyCitiesQuestion(){
  do {
    howManyCities = parseInt(prompt('How many cities have I lived in? 1 - 4'));
    if(howManyCities === 4) {
...
workHistoryQuestion();
videoGamesQuestion();
stayInWashingtonQuestion();
goRunningQuestion();
howManyCitiesQuestion();
movieQuestion();
