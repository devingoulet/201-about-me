...
//Creating functions for the questions

function livedinArizonaQuestion(){
  livedinArizona = prompt('Have I ever lived in Arizona? Yes or No').toLowerCase();
...
livedinArizonaQuestion();//for testing will move to the bottom later

function workHistoryQuestion(){
  workHistory = prompt('Did I work at Vans? Yes or No').toLowerCase();
  if(workHistory === 'yes') {
...
workHistoryQuestion();//for testing will move to the bottom later

function videoGamesQuestion(){
  videoGames = prompt('Do I play video games? Yes or No').toLowerCase();
  if(videoGames === 'yes') {
...
videoGamesQuestion();//for testing will move to the bottom later

function stayInWashingtonQuestion(){
  stayinWashington = prompt('Will I stay in Washington? Yes or No').toLowerCase();
...
stayInWashingtonQuestion();//for testing will move to the bottom later
